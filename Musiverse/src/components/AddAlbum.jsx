  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-white">
      ...
      <div className="flex-grow flex items-center justify-center">
        ...
        >
          <h2 className="text-2xl font-bold text-center mb-6 text-black">Upload an Album</h2>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              <label htmlFor="audio" className="block font-medium mb-1 text-black">
                Upload a Song
              </label>
              <input
                type="file"
            ...
            <Grid item xs={12} sm={6}>
              <label htmlFor="image" className="block font-medium mb-1 text-black">
            ...
            <Grid item xs={12} sm={6}>
              <label htmlFor="coverimage" className="block font-medium mb-1 text-black">
            ...
            <Grid item xs={12} sm={6}>
              <label htmlFor="genreimage" className="block font-medium mb-1 text-black">
                Genre Image
              </label>
              <input
                type="file"
